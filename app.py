...
def test_google_sheets_connection():
    try:
        ...
        print(f"🔐 成功連接到工作表: {os.getenv('SHEET_NAME')}")

        # 獲取所有資料
        data = sheet.get_all_records()  # 這會獲取整個工作表的所有記錄
        print("📊 資料:", data)

        return data

    except Exception as e:
        print("❌ 連接 Google Sheets 失敗:", e)
        return None
